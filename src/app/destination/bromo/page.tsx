...
export default function DestinationBromo() {
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-8 md:mb-10">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#040A2C] leading-tight max-w-4xl mx-auto">
            Nikmati Liburan Anda bersama keluarga di Gunung Bromo
          </h1>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="w-full lg:w-3/5">
            <div className="relative w-full aspect-[4/3] overflow-hidden rounded-xl">
              <Image
                src="/assets/images/bromo.svg" // GANTI DENGAN GAMBAR ANDA
        ...
        <div className="flex flex-col lg:flex-row gap-8 mt-8">
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-[#040A2C] text-white rounded-2xl p-8 flex flex-col items-center justify-center text-center h-full">
              ...
              <p className="text-5xl font-bold my-2">Rp. 3JT</p>
        ...
        <div className="mt-16">
          <h1 className="font-bold text-3xl lg:text-left md:text-4xl text-center">Rekomendasi Destinasi Lainnya</h1>
